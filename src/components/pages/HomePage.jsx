    ...
    <div>
        ...
        <div className="container">
            <Link to='/play3' onClick={playUiClick}>
                <Button className='sbtn' variant="outline-light">Tower Defense Game 3.0</Button>
            </Link>
        </div>
        <div className="container">
            <Link to='/upgrades' onClick={playUiClick}>
                <Button className='sbtn' variant="outline-light">Endless Upgrades</Button>
            </Link>
        </div>
        <div className="container">
            <Link to='/achievements' onClick={playUiClick}>
                <Button className='sbtn' variant="outline-light">Achievements</Button>
            </Link>
        </div>
        <div className="container">
        ...
        <div className="container">
            ...
            <div className="legacy-note">
                Database not configured - an old version of the game, kept here for historical purposes.
            </div>
        </div>
        <div className="container">
            <Link to='/play' onClick={playUiClick}>
                <Button className='sbtn' variant="outline-light">Tower Defense Game Version 2.0 Map Selection</Button>
            </Link>
        </div>
    </div>
);
